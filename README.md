This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and then ported to TypeScript. This uses [react-reflux](https://github.com/rintoj/react-reflux) - a redux implementation - library for state management.
