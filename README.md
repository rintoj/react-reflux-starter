This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and then ported to TypeScript. This uses `react-reflux` library for state management.
